...
const VERSION = 'pari-v1.33.1';
const SHELL = [
  './', './index.html', './style.css', './app.js', './i18n.js', './img/traguardi/coppa.webp', './img/traguardi/mondo.webp', './img/traguardi/vetta.webp', './img/traguardi/sdraio.webp', './img/traguardi/pesi.webp', './img/traguardi/calendario.webp', './img/traguardi/moneta.webp', './img/traguardi/scontrino.webp', './img/traguardi/categorie.webp', './img/traguardi/torta.webp', './img/scansione.webp', './manifest.webmanifest',
