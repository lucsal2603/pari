...
const VERSION = 'pari-v1.11.1';
const SHELL = [
  './', './index.html', './style.css', './app.js', './manifest.webmanifest',
  './icons/icon-192.png', './icons/icon-512.png', './icons/apple-touch-icon.png', './icons/favicon.png',
  './img/luca.png', './img/martina.png', './img/luca-avatar.png', './img/martina-avatar.png', './img/coppia.png', './img/nessuna-spesa.png', './img/luca-deve.png', './img/martina-deve.png', './img/logo.png', './img/benvenuto.png', './img/benvenuto-2.png'
];
