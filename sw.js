...
const VERSION = 'pari-v1.43.4';
const SHELL = [
  './', './index.html', './style.css', './app.js', './i18n.js', './img/traguardi/coppa.webp', './img/traguardi/mondo.webp', './img/traguardi/vetta.webp', './img/traguardi/sdraio.webp', './img/traguardi/pesi.webp', './img/traguardi/calendario.webp', './img/traguardi/moneta.webp', './img/traguardi/scontrino.webp', './img/traguardi/categorie.webp', './img/traguardi/torta.webp', './img/traguardi/salvadanaio.webp', './img/traguardi/tresalvadanai.webp', './img/traguardi/palloncino.webp', './img/traguardi/settimane.webp', './img/traguardi/sei.webp', './img/traguardi/compleanno.webp', './img/traguardi/sveglia.webp', './img/traguardi/mattino.webp', './img/traguardi/notte.webp', './img/traguardi/turno.webp', './img/traguardi/bilancia.webp', './img/traguardi/team.webp', './img/traguardi/collezione.webp', './img/traguardi/lingue.webp', './img/traguardi/scansione.webp', './img/scansione.webp', './img/missione.webp', './img/levelup-sfondo-2.webp', './img/levelup-stella.webp', './img/levelup-mascotte.webp', './img/tutorial/ciao.webp', './manifest.webmanifest',
