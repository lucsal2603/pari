...
const tabOf = (h) => { const n = (h || '').slice(2).split(/[/?]/)[0] || 'home'; return { spesa: 'spese', modifica: 'spese', attivita: 'spese', statistiche: 'home', bilanci: 'home', nuova: 'home', traguardi: 'home' }[n] || n; };
function route() {
